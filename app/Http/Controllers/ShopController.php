...
class ShopController extends SearchableController
{
    ...
    function list(Request $request)
    {
        ...
        session()->put('bookmark.promotion.list', $request->getUri());
    ...
    function create(Request $request)
    {
        try{
            ...
            return redirect()->route('admin.promotion')->with( 'status',"Promotion {$shop->code} was created.");
                // ... Normal process
    ...
    function delete($shopCode)
    {
        ...
        try{
            ...
            ->with('delete', "Shop {$shop->code} was deleted.");
        } catch(QueryException$excp) 
